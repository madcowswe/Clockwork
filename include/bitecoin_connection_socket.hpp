#ifndef bitecoin_connection_socket_hpp
#define bitecoin_connection_socket_hpp
...
{
private:	
	friend std::unique_ptr<Connection> bitecoin::OpenConnection_Socket(std::vector<std::string> &spec);
